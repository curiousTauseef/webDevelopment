...
public class ClientTesting {
    public static void main(String[] args) {
        ...
        //        listAllUsers();
        us.createUser(new User("Stian", "stian@gmail.com", "stian's password"));
        us.createUser(new User("Kenzie", "kenzie@gmail.com", "kenzie's password"));
        us.createUser(new User("Val", "val@tsag.com", "val's password"));
        //        listAllUsers();
        us.createUser(new User("Stine", "stine@hotmail.com", "stine's password"));
        us.deleteUserByEmail(u.getEmail());
        //        listAllUsers();
    }
