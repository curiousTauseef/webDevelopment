/*1428711176,,JIT Construction: v1685640,en_US*/
...
try {
    window.FB || (function (window) {
        ...
        var ES = require('ES');
        __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "1685640"});
        __d("JSSDKConfig", [], {
            "bustCache": true,
        ...
        __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
            ...
            function fa(oa, pa, qa, ra) {
                ...
                qa = k(qa);
                var sa = {jsonp: l, cors: i, flash: j}, ta;
                if (qa.transport) {
                    ta = [qa.transport];
                    delete qa.transport;
                ...
                ra({error: {type: 'no-transport', message: 'Could not find a usable transport for request'}});
            }
            ...
            function ha(oa) {
                ...
                va.method = ta;
                return {uri: qa, callback: ua, params: va};
            }
            ...
            function ka() {
                ...
                ia('/', 'POST', {batch: oa, include_headers: false, batch_app_id: v || ea}, function (ta) {
                    if (ES('Array', 'isArray', false, ta)) {
                        ...
                        return ua({error: {message: 'Fatal: batch call failed.'}});
                    });
                });
            }
            ...
            var ma = ES('Object', 'assign', false, new n(), {
                setAccessToken: function (oa) {
                    ...
                    w = oa;
                }, rest: la, graph: ia, scheduleBatchCall: ja
            });
        ...
        __d("PluginConfig", ["sdk.feature"], function (a, b, c, d, e, f, g) {
            b.__markCompiled && b.__markCompiled();
            var h = {
                post: {fluid: g('fluid_embed', false), mobile_fullsize: true},
                video: {fluid: true, full_width: true}
            };
            e.exports = h;
        }, null);
        __d("PluginTags", [], function (a, b, c, d, e, f) {
            ...
            var g = {
                ...
                page: {href: 'url', hide_cover: 'bool', show_facepile: 'bool', show_about: 'bool', show_posts: 'bool'},
                open_graph: {
                    href: 'url',
                    layout: 'string',
                    show_faces: 'bool',
                ...
                video: {allowfullscreen: 'bool', href: 'url'},
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1685640","message":"' + e.message + '"}}');
}
