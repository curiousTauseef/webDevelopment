...
public class EventAddActivity extends AppCompatActivity {
    ...
    private void init() {
        try {
            ...
            if (!createNew) { // update
                ...
                if (AuthenticationHelper.getInstance().getAccountName() == null) {
                    Toast.makeText(EventAddActivity.this, "Please Sing In!", Toast.LENGTH_SHORT).show();
                } else {
                    emailEt.setText(AuthenticationHelper.getInstance().getAccountName());
                }
            }
    ...
    private void confirmAction() {
        if (AuthenticationHelper.getInstance().getLoginStatus() == LoginStatus.LOGGED_OUT) {
        ...
        String message = "";
        if (!isValidEmail(AuthenticationHelper.getInstance().getAccountName())) {
            log("error! your account: " + AuthenticationHelper.getInstance().getAccountName() +
                    " is not an valid email" +
                    " address");
            message = "error! your account: " + AuthenticationHelper.getInstance().getAccountName() +
                    " is not an valid email  address!";
        } else {
            e.setOwnerEmail(AuthenticationHelper.getInstance().getAccountName());
        }
