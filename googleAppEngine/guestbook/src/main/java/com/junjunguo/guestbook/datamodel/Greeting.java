...
/**
 * The @Entity tells Objectify about our entity.  We also register it in {@link OfyHelper} Our primary key @Id is set
 * automatically by the Google Datastore for us.
 * <p/>
 * We add a @Parent to tell the object about its ancestor. We are doing this to support many guestbooks.  Objectify,
